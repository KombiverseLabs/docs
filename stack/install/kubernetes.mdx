...
description: Deploy kombify TechStack on Kubernetes using Helm
sidebarTitle: Kubernetes
---


Deploy kombify TechStack on Kubernetes using the official Helm chart. This is recommended for production environments requiring high availability.
