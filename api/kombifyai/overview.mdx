...
All endpoints (except health and A2A federation) require authentication via Auth0 JWT token or API key. Requests are validated at the Cloudflare edge (`api.kombify.io`) before reaching the origin services.
