...
The kombify platform consists of five interconnected tools, each solving a specific problem in the homelab infrastructure lifecycle.
...
<CardGroup cols={2}>
  ...
  <Card title="TechStack" icon="layer-group" href="/stack/overview">
    **Deploy & Orchestrate**
...
sequenceDiagram
    ...
    You->>StackKits: Choose blueprint (e.g., Base Kit)
...
<CardGroup cols={3}>
  ...
  <Card title="Start with TechStack" icon="layer-group" href="/stack/overview">
    **Deploy now**
