...
graph TB
    subgraph Beginner["For Beginners"]
        Base["base-homelab<br/>━━━━━━━━━━━<br/>4-6 services<br/>Single node<br/>Docker only"]
    end

    subgraph Advanced["For Advanced Users"]
        HA["ha-homelab<br/>━━━━━━━━━━━<br/>8-12 services<br/>Multi-node<br/>High availability"]
    end

    subgraph Power["For Power Users"]
        Modern["modern-homelab<br/>━━━━━━━━━━━<br/>15+ services<br/>Kubernetes<br/>Full GitOps"]
    end

    style Beginner fill:#d1fae5,stroke:#059669
    style Advanced fill:#fef3c7,stroke:#d97706
    style Power fill:#fce7f3,stroke:#db2777
```
...
graph TB
    ...
    style Layer3 fill:#fce7f3,stroke:#db2777
...
flowchart LR
    ...
    subgraph Validation
        V1["✓ YAML syntax"]
        V2["✓ Required fields"]
        V3["✓ Service dependencies"]
        V4["✓ Port conflicts: none"]
        V5["✓ Network config"]
        V6["✓ SSL config"]
    end
    ...
    style StackKit fill:#fce7f3,stroke:#db2777
    style Validation fill:#d1fae5,stroke:#059669
...
graph TB
    subgraph BaseHomelab["base-homelab StackKit"]
        subgraph Services["Included Services"]
            ...
            Authelia["🔐 Authelia<br/><i>Authentication</i>"]
            Homepage["📊 Homepage<br/><i>Dashboard</i>"]
            Portainer["🐳 Portainer<br/><i>Docker UI</i>"]
        end

        subgraph Preconfigured["Pre-Configured"]
            Routes["• Traefik routes all services"]
            Auth["• Authelia protects admin pages"]
            Discovery["• Homepage auto-discovers"]
    ...
    style Preconfigured fill:#d1fae5,stroke:#059669
    style YouConfigure fill:#fef3c7,stroke:#d97706
```
...
flowchart LR
    ...
    style Extend fill:#e0f2fe,stroke:#0284c7
    style Define fill:#fce7f3,stroke:#db2777
    style Test fill:#d1fae5,stroke:#059669
```
