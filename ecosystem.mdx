...
- Available kits: `base-homelab` (v1.0), `modern-homelab` (v1.1 planned), `ha-homelab` (v1.2 planned)
...
<Info>
  ...
  **BSL-1.1 allows production use for organizations with <$1M ARR. Converts to Apache 2.0 after 4 years.
</Info>
