...
- Access to the [kombify Simulate API](/api/kombisim/overview)
- [kombify TechStack](/api/kombistack/overview) orchestrator configured
...
<CardGroup cols={2}>
  ...
  <Card title="Create Snapshots" icon="camera" href="/api/kombisim/overview">
...
- [kombify Simulate API](/api/kombisim/overview) - VM management
