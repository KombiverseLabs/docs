...
kombifyStack is available under a **dual license**:

- **Apache License 2.0** - Permissive license for commercial use
- **GNU General Public License v3.0 (GPLv3)** - Copyleft license for open-source projects

You may choose whichever license best suits your needs. Commercial licensing options are available for organizations requiring alternative terms.

See the [LICENSE](https://github.com/kombifyLabs/kombifyStack/blob/main/LICENSE) file for details.
