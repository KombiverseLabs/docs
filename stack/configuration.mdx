...
<Tabs>
  <Tab title="Local auth">
    ...
    | `KOMBISTACK_AUTH_PROVIDER` | `local` | Auth provider: local, oidc, sphere |
  ...
  <Tab title="Sphere SSO">
    | Variable | Default | Description |
    |----------|---------|-------------|
    | `KOMBISTACK_AUTH_PROVIDER` | `sphere` | Use kombify Sphere for auth |
    | `KOMBISTACK_SPHERE_ENDPOINT` | - | Sphere API endpoint |
    | `KOMBISTACK_SPHERE_API_KEY` | - | Sphere API key |
  </Tab>
</Tabs>
...
| `KOMBISTACK_AI_TEMPERATURE` | `0.7` | Response creativity (0.0–2.0) |
