...
|-----|----------|------------|
| `base-kit` | Single-environment (local or cloud) | Low |
| `modern-homelab` | Hybrid (cloud + local, both mandatory) | Medium |
| `ha-kit` | High availability (failover, redundancy) | High |
