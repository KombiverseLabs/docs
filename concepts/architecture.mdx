...
graph TB
    ...
    subgraph StackKits["StackKits"]
        CUE["CUE Schemas"]
        Base["Base Kit"]
        HA["High Availability Kit"]
        Modern["Modern Homelab Kit"]
    end
...
graph TB
    subgraph Layer3["Layer 3: StackKits"]
        Base["Base Kit<br/><i>Single-node Docker</i>"]
        HA["High Availability Kit<br/><i>High availability</i>"]
        Modern["Modern Homelab Kit<br/><i>Multi-node Docker + Coolify</i>"]
    end

    subgraph Layer2["Layer 2: Platforms"]
        Docker["docker/<br/><i>Docker + Traefik</i>"]
        Coolify["coolify/<br/><i>Docker + Headscale VPN</i>"]
    end
