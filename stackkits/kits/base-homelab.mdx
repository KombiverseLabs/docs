...
The **base-homelab** StackKit is designed for beginners and single-node setups. It provides a carefully curated set of services that work well together out of the box, with multiple **variants** to match your needs.
