...
- [DOCUMENTATION-STANDARD.md](../DOCUMENTATION-STANDARD.md) — 3-Tier-Doku-Modell, Diataxis-4-Level, Writing-Rules. Section 1 gilt fuer dieses Repo.
...
- [DEVELOPMENT-STANDARDS.md](../kombify%20Core/standards/DEVELOPMENT-STANDARDS.md) — Repo-Konventionen, Brand/Naming (Section 6 von DOCUMENTATION-STANDARD).
...
- **Images:** SVGs werden aus `kombify Core/internal-docs/diagrams/` manuell promoted nach `images/architecture/`. Saturday-Workflow (siehe DOCUMENTATION-STANDARD §9).
