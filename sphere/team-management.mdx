...
description: Manage team members and roles in Sphere
...
Sphere provides comprehensive team management for collaborative homelab administration. Invite members, assign roles, and control access across all connected environments.
...
Sphere uses role-based access control (RBAC) with four predefined roles:
...
- Instructions to create account (if new to Sphere)
...
<Tabs>
  <Tab title="Setup overview">
    ...
    2. Add OIDC settings in Sphere
    3. Map IdP groups to Sphere roles
...
See [Enterprise](/sphere/enterprise) for detailed SSO setup.
