...
- Integration guides for Auth0, Coolify, and Proxmox
...
### StackKits
- **Base Kit** (`base-homelab`) — Single-environment pattern (local or cloud, any node count)
- **Modern Homelab Kit** (`modern-homelab`) — Hybrid pattern (cloud + local, both mandatory)
- **High Availability Kit** (`ha-homelab`) — HA pattern (automatic failover, redundancy)
...
<CardGroup cols={2}>
  <Card title="Report a bug" icon="bug" href="https://github.com/kombify/techstack/issues">
    Open an issue on GitHub
  </Card>
  <Card title="Request a feature" icon="lightbulb" href="https://github.com/kombify/techstack/discussions">
    Start a discussion
  </Card>
  <Card title="Contributing guide" icon="code-pull-request">
...
- **GitHub Releases:** [github.com/kombify/techstack/releases](https://github.com/kombify/techstack/releases)
