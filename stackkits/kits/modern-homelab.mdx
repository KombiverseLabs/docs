...
Coolify manages deployments across your nodes. While the Base Kit uses Dokploy within a single-environment pattern, Coolify provides additional capabilities for hybrid setups:
