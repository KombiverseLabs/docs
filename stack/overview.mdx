...
```mermaid
flowchart LR
    Intent["📝 Your File<br/><i>kombination.yaml</i>"]
...
<Card title="Self-Hosting Guide" icon="server" href="/stack/how-to/self-hosting">
...
<Columns cols={2}>
  ...
  <Card title="Architecture Deep Dive" icon="sitemap" href="/stack/explanations/architecture">
...
<Columns cols={3}>
  <Card title="Troubleshooting" icon="wrench" href="/stack/reference/troubleshooting">
