...
<Warning>
  The Modern Homelab Kit has higher complexity and resource requirements than the Base Kit. If you only need a single local server, use the [Base Kit](/stackkits/kits/base-kit) instead.
</Warning>
...
<CardGroup cols={2}>
  <Card title="Monitoring Setup" icon="chart-line" href="/stack/reference/monitoring">
    Configure the PLG observability stack
  </Card>
  <Card title="Coolify Guide" icon="rocket" href="/integrations/coolify">
