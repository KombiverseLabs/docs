...
KombiSphere enables you to manage **cloud VPS** and **local home servers** as a single logical infrastructure, with secure networking and unified configuration.

## What is hybrid infrastructure?

Traditional infrastructure management treats cloud and on-premises as separate worlds. KombiSphere unifies them:
...
KombiSphere distinguishes between different node types:
...
KombiSphere uses [Headscale](https://github.com/juanfont/headscale) (self-hosted Tailscale) to create a secure mesh network between all nodes.
