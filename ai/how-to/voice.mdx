...
kombify AI supports voice interaction through text-to-speech (TTS) and speech-to-text (STT), enabling hands-free homelab management. The underlying voice framework is [SpeechKit](/ai/how-to/speechkit), which provides the full STT/TTS pipeline and real-time voice agent capabilities.
