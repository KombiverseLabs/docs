...
│  kombify Portal │ │ kombify Gateway │ │ kombify Stack   │ │ kombify Sim     │
...
<CardGroup cols={2}>
  <Card title="kombify Portal" icon="browser" href="/cloud/overview">
  ...
  <Card title="kombify Gateway" icon="code" href="/api/introduction">
