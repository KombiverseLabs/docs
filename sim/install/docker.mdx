...
description: Install kombify Simulate using Docker
sidebarTitle: Docker
---


The fastest way to run kombify Simulate is with a single Docker container.
...
<Steps>
  ...
  <Step title="Access the dashboard">
    ...
    <Tip>
      No authentication required by default — kombify Simulate is designed for local development.
    </Tip>
  </Step>
</Steps>
