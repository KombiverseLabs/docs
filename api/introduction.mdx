...
<CardGroup cols={3}>
  ...
  <Card title="Cloud API" icon="cloud" href="/api/kombify Cloud/overview">
...
| **Cloud** | Managed SaaS platform | JWT / API key | `https://api.kombify.io/v1` (via Kong Gateway) |
...
| Plan | Stack API | Sim API | Cloud API |
|------|-----------|---------|------------|
