...
Find answers to the most common questions about kombify. Can't find what you're looking for? [Contact support](mailto:support@kombify.dev) or ask in our [Discord community](https://discord.gg/kombify).
...
<AccordionGroup>
  <Accordion title="What is kombify?">
    ...
    - **kombify Stack** - Orchestration engine for deploying infrastructure
    - **kombify Sim** - Simulation environment for testing before deploying
    - **kombify StackKits** - Pre-built templates for common setups
    - **kombify Sphere** - Cloud dashboard for management and collaboration
  ...
  <Accordion title="Is kombify free?">
    ...
    All core tools (Stack, Sim, StackKits) are open source and free to self-host. kombify Sphere provides optional cloud features.
    
    [View pricing →](/sphere/pricing)
  </Accordion>
  ...
  <Accordion title="Can I use kombify without coding?">
    ...
    - **Beginners**: Use the Easy Wizard in kombify Sphere to answer simple questions and generate a working configuration
    ...
    [Start with Easy Wizard →](/sphere/getting-started)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="How do I install kombify Stack?">
    ...
    [Full installation guide →](/stack/install/docker)
  </Accordion>
  
  <Accordion title="Can I run kombify on Windows or macOS?">
    kombify Stack and Sim run in Docker, so they work anywhere Docker runs:
...
<AccordionGroup>
  <Accordion title="What is kombination.yaml?">
  ...
  <Accordion title="How do I customize a StackKit?">
    ...
    **3. Custom StackKit** (advanced):
    ...
    [Customization guide →](/stackkits/creating-custom)
  </Accordion>
...
<AccordionGroup>
  <Accordion title="What is kombify Sim for?">
    kombify Sim creates virtual environments to **test your configuration before deploying to real hardware**. This helps you:
  ...
  <Accordion title="Docker or QEMU - which should I use?">
    ...
    **Recommendation:** Start with Docker for speed, use QEMU for final validation.
    ...
    [Engine configuration →](/sim/configuration)
  </Accordion>
  ...
  <Accordion title="How do I SSH into simulation nodes?">
    ...
    [SSH access guide →](/sim/ssh-access)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Agent won't connect to Stack">
    ...
    **Debug steps:**
    ...
    [Full troubleshooting →](/stack/troubleshooting)
  </Accordion>
  
  <Accordion title="Deployment fails with validation error">
    Validation errors mean your `kombination.yaml` doesn't match the StackKit schema.
...
<CardGroup cols={3}>
  ...
  <Card title="GitHub Discussions" icon="github" href="https://github.com/kombify/kombifyStack/discussions">
    Ask technical questions
  </Card>
  <Card title="Email Support" icon="envelope" href="mailto:support@kombify.dev">
