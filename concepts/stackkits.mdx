...
<CardGroup cols={3}>
  <Card title="base" icon="house" href="/stackkits/kits/base-homelab">
    **Single-environment**
  ...
  <Card title="ha" icon="shield-halved" href="/stackkits/kits/ha-homelab">
    **High-availability**
  ...
  <Card title="modern" icon="rocket" href="/stackkits/kits/modern-homelab">
