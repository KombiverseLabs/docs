...
description: Install kombify TechStack using Docker Compose
sidebarTitle: Docker
---


The fastest way to get kombify TechStack running is with Docker Compose. This guide covers installation on any Linux server with Docker installed.
