...
graph TB
    ...
    subgraph Tools["kombify Tools"]
        ...
        Sim["kombifySim<br/>🧪 Testing"]
        Stack["kombifyStack<br/>🚀 Deployment"]
        Platform["kombify Cloud<br/>☁️ Management"]
...
<CardGroup cols={2}>
  ...
  <Card title="kombify Platform" icon="globe" href="/sphere/overview">
    **Managed Platform**
...
graph LR
    subgraph OpenCore["Open Core (Self-Hosted)"]
        SK["StackKits<br/>Apache 2.0 + GPLv3"]
        Sim["kombifySim<br/>Apache 2.0 + GPLv3"]
        Stack["kombifyStack<br/>Apache 2.0 + GPLv3"]
    end
