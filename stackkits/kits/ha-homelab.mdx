...
graph TB
    ...
    style Cluster fill:#f0f9ff,stroke:#0369a1
    style Node1 fill:#d1fae5,stroke:#059669
    style Node2 fill:#fef3c7,stroke:#d97706
    style Node3 fill:#f3e8ff,stroke:#9333ea
```
...
graph LR
    ...
    style Replica1 fill:#fef3c7,stroke:#d97706
    style Replica2 fill:#f3e8ff,stroke:#9333ea
```
...
graph TB
    ...
    style Internal fill:#dbeafe,stroke:#2563eb
```
