...
graph TB
    ...
    subgraph Power["For Advanced Users"]
        Modern["modern-homelab<br/>━━━━━━━━━━━<br/>10+ services<br/>Multi-node Docker<br/>Full Observability"]
    end
...
| **Platforms** | Container orchestration | Docker + Traefik |
...
graph TB
    subgraph BaseHomelab["base-homelab StackKit"]
        subgraph Services["Included Services"]
            ...
            Authelia["🔐 TinyAuth/PocketID<br/><i>Authentication</i>"]
        ...
        subgraph Preconfigured["Pre-Configured"]
            ...
            Auth["• TinyAuth/PocketID protects admin pages"]
...
# That's it! Traefik, TinyAuth/PocketID, Homepage are auto-configured
```
...
| **Orchestration** | Docker | Docker Swarm | Docker + Coolify |
| **High Availability** | ❌ | ✅ | ✅ |
