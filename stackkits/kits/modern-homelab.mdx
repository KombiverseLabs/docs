...
<Warning>
  **v1.1 Planned** -- This StackKit is designed and specified but not yet functional. Use the [Base Kit](/stackkits/kits/base-homelab) for v1.0 deployments.
</Warning>
...
<Warning>
  The Modern Homelab Kit has higher complexity and resource requirements than the Base Kit. If you only need a single local server, use the [Base Kit](/stackkits/kits/base-homelab) instead.
</Warning>
