...
<Warning>
  ...
  - [Modern Homelab Kit](/stackkits/kits/modern-homelab) — Multi-node with Headscale VPN
  - [High Availability Kit](/stackkits/kits/ha-kit) — High-availability Docker Swarm cluster
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Create custom StackKit" icon="plus" href="/stackkits/explanations/cue-architecture">
