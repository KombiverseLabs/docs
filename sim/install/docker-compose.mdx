...
description: Install kombify Simulate using Docker Compose for persistent deployments
sidebarTitle: Docker Compose
---


Use Docker Compose for a more manageable, persistent kombify Simulate deployment.
...
graph TB
    subgraph DockerHost["Docker Host"]
        subgraph KombiSim["kombify Simulate container"]
...
For accessing kombify Simulate remotely with HTTPS:
