...
<Note>
  For a deep dive into the identity architecture, see [Identity & security concepts](/concepts/identity).
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="I'm setting up kombify for my team" icon="users">
    Use **Zitadel OIDC** with kombify Sphere:
    - Centralized user management
    - Role-based access control
    - SSO across all kombify tools
    
    See [Zitadel setup](/guides/auth/zitadel-setup).
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Identity concepts" icon="lightbulb" href="/concepts/identity">
