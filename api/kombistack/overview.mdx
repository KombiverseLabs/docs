...
```bash
# Authenticate via Auth0 OIDC
# 1. Obtain a token from your Auth0 instance
...
<CardGroup cols={2}>
  ...
  <Card title="Validation" icon="wand-magic-sparkles" href="/api/kombistack/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Validation API" icon="wand-magic-sparkles" href="/api/kombistack/overview">
