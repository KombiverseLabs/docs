...
description: Learn how to create your first simulated VM in kombify Simulate and deploy the Modern Homelab Kit
sidebarTitle: First Sim-VM Deployment
icon: server
---


This guide walks you through creating your first simulated VM using kombify Simulate and deploying the base homelab StackKit. This is perfect for testing your homelab configurations before deploying to production hardware.

<Info>
  **Mock Engine Notice**: kombify Simulate runs on a mock engine in Azure Container Apps since Docker-in-Docker is not available. All VM operations are simulated to demonstrate the workflow.
</Info>
...
- Access to the [kombify Simulate API](/api/kombifysim/overview)
- [kombify TechStack](/api/kombifytechstack/overview) orchestrator configured
...
## Step 2: Deploy the Modern Homelab Kit

### Parse StackKit Configuration

The [Modern Homelab Kit](/stackkits/kits/modern-homelab) includes:
...
<CardGroup cols={2}>
  ...
  <Card title="Create Snapshots" icon="camera" href="/api/kombifysim/overview">
    Save VM state before making changes
  </Card>
  <Card title="Scale Resources" icon="arrows-up-down" href="/api/kombifysim/nodes">
...
- [kombify Simulate API](/api/kombifysim/overview) - VM management
- [Stack API](/api/kombifytechstack/overview) - Stack orchestration
- [StackKits](/stackkits/kits/modern-homelab) - Modern Homelab Kit specifications
