...
Get your first homelab running in under 5 minutes using the managed kombify Sphere platform. No installation required — just sign up, answer a few questions, and deploy.
...
<Steps>
  <Step title="Sign up">
    Go to [app.kombisphere.io](https://app.kombisphere.io) and create a free account using your email or GitHub.
  </Step>
...
<Steps>
  <Step title="Start simulation">
    Click **"Simulate"** to launch kombify Sim. This creates Docker containers that behave like real servers.
  </Step>
