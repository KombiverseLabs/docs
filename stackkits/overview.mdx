...
<CardGroup cols={3}>
  ...
  <Card title="modern-homelab" icon="microchip" href="/stackkits/kits/modern-homelab">
    **For scale**
    ...
    Multi-node Docker infrastructure for advanced users.
...
<AccordionGroup>
  ...
  <Accordion title="I want multi-node infrastructure" icon="cloud">
    **Use: modern-homelab**
    
    For advanced users wanting:
    - Docker + Coolify PaaS
    - VPN overlay (Headscale)
    - Full observability (Prometheus, Grafana, Loki)
    
    Requires more resources (24GB+ RAM) but offers maximum flexibility.
  </Accordion>
</AccordionGroup>
...
|---------|-------------|------------|----------------|
| **Nodes** | 1 | 2-5 | 3+ |
| **Orchestration** | Docker Compose | Docker Swarm | Docker + Coolify |
| **Complexity** | Low | Medium | High |
| **Min Resources** | 4GB RAM | 16GB RAM | 24GB+ RAM |
