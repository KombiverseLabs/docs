...
│   kombify Portal    │       │   kombify Stack     │       │   kombify Sim       │
│   (SvelteKit)       │       │   (Go + gRPC)       │       │   (Go + REST)       │
│                     │       │                     │       │                     │
│   app.kombify.io    │       │   api.kombify.io    │       │   sim.kombify.io    │
└─────────────────────┘       └─────────────────────┘       └─────────────────────┘
```
...
<CardGroup cols={2}>
  <Card title="kombify Portal" icon="browser" href="/sphere/cloud/overview">
  ...
  <Card title="kombify Stack" icon="server" href="/stack/overview">
    Go-based orchestration API with gRPC support. Manages infrastructure
    provisioning and node communication at `api.kombify.io`.
  </Card>
...
| **Container Apps** | Stack and Sim APIs | Consumption |
...
| `api.kombify.io` | Container App | Stack API |
